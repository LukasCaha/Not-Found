...
public class Shooter : MonoBehaviour
{
    ...
    public Transform cannonExtension;
    ...
    void Shoot()
    {
        ...
        b.GetComponent<fly>().direction = cannonExtension.position - cannonBarel.position;
        if (b.transform.childCount >0)
            b.transform.GetChild(0).LookAt(cannonExtension);
    }
}
